...
본 시스템의 거래는 zk-ERC20로 명명하는 익명화 토큰에 기반한다. 영지식증명 기술로 거래 참여자와 내역은 숨겨 거래

완전히 익명화된다. 이를 통해 판매자와 소비자 양 측의 프라이버시를 보장함으로써 마켓 참여에 대한 장벽의 높이를 크게 줄인다. 더불어 P2P 거래에 대한 기능을 강화해 개인 간 에너지 거래에 대한 신뢰성을 높인다. 블록체인 기술 자체가 갖는 장점에 우리의 솔루션이 더해진다면 P2P 에너지 거래 마켓에 회의적이던 사용자들에게도 충분한 유인책을 마련할 수 있을 것이다. 또한 다른 시스템들이 갖고 있는 개인 정보 측면의 보안 취약점이 해결될 수 있다.
