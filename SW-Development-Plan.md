...
블록체인을 통해 중앙화된 주체 없이 공급자ᆞ소비자ᆞ프로슈머 간 에너지 직거래가 가능해진다. P2P(Peer-to-Peer) 에너지 거래 방식을 통해 사용자들은 합리적인 가격에 전기를 구매해 사용할 수 있고, 태양광 발전을 통해 에너지를 생산하는 프로슈머라면 남는 전기를 이웃에게 팔 수 있다. 또한 소규모 전력자원을 모아서 거래하고 현황, 실적을 체계적으로 관리하는 '전력 중개 사업' 등 신사업 파생을 지원한다.

본 시스템은 블록체인상 거래에서 내역이 공개됨으로써 야기되는 개인정보 유출 문제를 방지할 수 있고, 따라서 보다 안전한 서비스를 제공한다. 또한 유니스왑 프로토콜을 통해 시장 교란 행위를 방지하고 사용자 개입없이 자동으로 수요를 조정하는 자동화 수요반응자원(Automated Demand Response)을 달성한다.

PoA(Proof of Authority) 기반의 높은 TPS(Transaction Per Second)를 가지는 플라즈마 블록체인에서 거래가 이뤄지므로 지체없이 빠른 P2P 에너지 거래 서비스를 제공한다.

#### 서비스 형태의 추론



데이터의 가용성을 극대화할 수 있는 시스템은 한전 빅데이터 융합센터와 같이 기존에 데이터 제공에만 머무르던 기관을 실시간 수요 예측에 참여시킬 수 있다. 이를 통해 프로슈머 개개인은 자신의 에너지 소비에 대한 피드백을 받고 자신의 전력을 좀 더 효율적으로 관리할 수 있다.
...
**(3) 자신의 에너지 소비에 대한 즉각적인 피드백**
  ...
  마지막으로, 각 프로슈머들은 자신이 생산하고 소비하는 전력에 대한 효율적인 관리가 가능해진다. 실시간으로 블록체인 상의 전력 사용 데이터 등을 활용해 머신러닝이나 데이터 분석을 수행하는 것은 여러 면에서 한계가 있기에, 
...
에너지 거래에 블록체인 시스템을 도입해 다음과 같은 효과를 누린다[13].

* 경제성: 실시간 전력망에 기반해 소비자는 가장 값싼 전기를 탐색 구매할 수 있으며, 공급자는 잉여 전력 유지보수 비용을 절감할 수 있다. 또한 중간 거래 비용을 획기적으로 줄일 수 있다.

* 투명성: 영지식증명으로 거래 참여자와 내역은 숨기면서도 검증을 수행할 수 있다.

* 안정성: 거래 원장(ledger)이 분산 기록돼 임의 변경이 사실상 불가능하다.

* 효율성: 실시간 전력망과 P2P 거래는 재생 에너지 간헐성 문제를 해결해 효율을 증대시킨다.
